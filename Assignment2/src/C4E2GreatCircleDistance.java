...
public class C4E2GreatCircleDistance {
    public static void main(String[] args){
        ...
        System.out.println("Enter point 1 (latitude and longitude) in degrees separated by spaces:");
        double x1 = input.nextDouble();
        double y1 = input.nextDouble();
        System.out.println("Enter point 2 (latitude and longitude) in degrees separated by spaces:");
